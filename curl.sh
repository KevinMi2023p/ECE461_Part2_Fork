...
# Please change the IP address to IPV4
# Windows user using ipconfig
# MAC users use google.

curl --location 'https://192.168.10.42:8080/package' \
...
# curl --location 'http://localhost:8080/package' \
# --header 'Content-Type: application/json' \
# --data-raw '{
# 	"metadata": {
# 		"Name": "Underscore",
